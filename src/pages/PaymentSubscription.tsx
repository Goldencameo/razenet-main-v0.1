...
import { ArrowLeft, CreditCard, Lock, Crown, Hammer, Sparkles } from 'lucide-react';
...
export default function PaymentSubscription() {
  ...
  const handlePayment = (e: React.FormEvent) => {
    ...
    if (!selectedPlan) {
      toast({ title: 'Error', description: 'Invalid plan', variant: 'destructive' });
      return;
    }
    ...
    setTimeout(() => {
      ...
      // Save subscription
      localStorage.setItem('active-subscription', JSON.stringify({
      ...
      toast({
        ...
        description: `You have subscribed to ${selectedPlan.name}`,
      });
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground mb-4">Invalid plan</p>
      ...
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h1 className="text-3xl font-bold text-foreground">Subscribe to {selectedPlan.name}</h1>
          </div>
        ...
        <div className="grid lg:grid-cols-[4fr_1fr] gap-8">
          ...
          <div className="space-y-6 min-w-0">
            ...
            <div className="flex items-center gap-2 text-sm text-muted-foreground p-4 bg-muted/50 rounded-lg border border-border">
              ...
              <p>Your payment information is encrypted and secure. Cancel anytime from settings.</p>
            </div>
          </div>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center gap-4 p-6 bg-primary/5 rounded-lg border border-primary/20">
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="font-semibold text-foreground text-xl mb-2 whitespace-nowrap">{selectedPlan.name}</h3>
                    <p className="text-sm text-muted-foreground">Monthly subscription</p>
                  </div>
                  <div className="text-right flex-shrink-0 min-w-[140px]">
                    <p className="text-4xl font-bold text-foreground mb-1">${selectedPlan.price}</p>
